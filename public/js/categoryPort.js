...
const anchorpencil = document.getElementsByClassName("anchorpencil");
...
$(document).ready(function () {
  $("#CreateService").validate({
    ...
    messages: {
      title: {
        required: "Service name must be given. ",
      },
      images: {
        required: "Please upload the images.",
      },
      priceInfo: {
        maxlength: "Price information should be less than 600 characters.",
      },
      teamInfo: {
        maxlength: "Team information should be less than 600 characters.",
      },
    },
  });
});
